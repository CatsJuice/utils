...
export const isNull = (val: any): val is null => getTypeName(val) === 'null'
export const isRegExp = (val: any): val is RegExp => getTypeName(val) === 'regexp'
export const isDate = (val: any): val is Date => getTypeName(val) === 'date'
